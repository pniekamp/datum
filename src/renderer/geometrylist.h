...
class GeometryList
{
  ...
  public:
    ...
    void push_terrain(BuildState &state, lml::Transform const &transform, Mesh const *mesh, Texture const *heightmap, Texture const *normalmap, lml::Rect2 const &region, lml::Vec4 const &areascale, float morphbeg, float morphend, float morphgrid, Material const *material, Texture const *blendmap, int layers, lml::Vec2 const &uvscale = { 1.0f, 1.0f });

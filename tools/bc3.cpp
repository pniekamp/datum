...
namespace
{
  ...
  {
    static constexpr float epsilon = (0.25f / 64.0f) * (0.25f / 64.0f);
  ...
  void encode_color(uint32_t block[16], BC3 *result)
  {
    ...
    {
      static constexpr size_t palette[] = { 0, 2, 3, 1 };
  ...
  {
    static constexpr float epsilon = (1.0f / 64.0f) * (1.0f / 64.0f);
  ...
  void encode_alpha(uint32_t block[16], BC3 *result)
  {
    ...
    if (alpha0 != alpha1)
    {
      static constexpr size_t palette[] = { 1, 7, 6, 5, 4, 3, 2, 0 };

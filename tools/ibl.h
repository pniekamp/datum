...
void image_pack_watercolor(lml::Color3 const &deepcolor, lml::Color3 const &shallowcolor, float scalepower, lml::Color3 const &fresnelcolor, float fresnelbias, float fresnelpower, int width, int height, void *bits);
